            ...
            fn synthesize(
                ...
                layouter.assign_region(
                    ...
                    |mut gate| {
                        ...
                        // 8-bit
                        add_row(F::zero(), F::from(0b1111_1111), F::from(0b0101_0101_0101_0101))?;
                        add_row(F::one(), F::from(0b1_0000_0000), F::from(0b01_0000_0000_0000_0000))?;
                        // 9-bit
                        add_row(F::one(), F::from(0b1_1111_1111), F::from(0b01_0101_0101_0101_0101))?;
                        add_row(F::from(2), F::from(0b10_0000_0000), F::from(0b0100_0000_0000_0000_0000))?;
                        // - 10-bit
                        add_row(
                            F::from(2),
